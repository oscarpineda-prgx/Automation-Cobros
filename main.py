...
def build_parser() -> argparse.ArgumentParser:
    ...
    cpa_downloads.add_argument("--rfc", default=None, help="RFC a capturar en emitidos y recibidos")
    ...
    cpa_request.add_argument("--rfc", default=None, help="RFC a capturar en emitidos y recibidos")
